...
const activities = [
  {
    id: 1,
    name: "Complete JavaScript Basics Course",
    description: "Finish all modules and quizzes in the JavaScript Basics course.",
    reward: 50,
    category: "Education",
    imageUrl: "src/assets/javascript.avif"
  },
  {
    id: 2,
    name: "Participate in Weekly Coding Challenge",
    description: "Solve at least 3 problems in this week's coding challenge.",
    reward: 30,
    category: "Coding",
    imageUrl: "src/assets/coding.avif"
  },
  {
    id: 3,
    name: "Attend Blockchain Workshop",
    description: "Join our special workshop and earn bonus EdCoins.",
    reward: 70,
    category: "Education",
    imageUrl: "src/assets/blockchain.avif"
  },
  {
    id: 4,
    ...
    reward: 100,
    category: "Education",
    imageUrl: "src/assets/projects.avif"
  },
  {
    id: 5,
    ...
    reward: 20,
    category: "Education",
    imageUrl: "src/assets/week.avif"
  },
  {
    id: 6,
    name: "Sports Event",
    description: "Participate in Sports Event",
    reward: 20,
    category: "Sports",
    imageUrl: "src/assets/sports.avif"
  },
];
const rewardsData = [
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {rewards.length > 0 ? (
                ...
                >
                  ...
                  <div className="p-4 flex flex-col flex-grow">
                    ...
                    <div className="flex justify-between items-center mt-auto pt-3 border-t border-slate-200">
                      ...
                      >
                        {canAfford ? "Participate" : "More Coins Needed"}
                      </button>
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center text-slate-500">
            No Activites available at the moment. Check back soon!
          </div>
        )}
      </div>{" "}
      {/* End max-w container */}
